  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <Button variant="default" className="md:hidden bg-black text-white" onClick={() => setOpen(true)}>
          <Filter className="mr-2 h-4 w-4" />
          Filter
          {totalActiveFilters > 0 && (
            <span className="ml-1 bg-white text-black rounded-full w-5 h-5 text-xs flex items-center justify-center">
              {totalActiveFilters}
            </span>
          )}
        </Button>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    activeCategory === key ? "bg-blue-50 text-blue-600" : "text-gray-700",
                  )}
